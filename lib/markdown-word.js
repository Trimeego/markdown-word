...
(function() {
  ...
  processMarkdownObject = function(object, levelOffset) {
    var attributes, childElements, children, count, el, elements, fragments, itemElements, itemType, l, level, lines, objectType, out, r, rels, rid, title, _i, _j, _k, _len, _len1, _len2;
    children = [];
    rels = [];

...
(function() {
  var XML, addRelationship, buildDocumentFromFragments, buildDocumentFromMarkdown, buildDocumentObjectFromFragments, documentAttrs, documentSectionProps, fs, http, https, markdown, markdownFromFile, markdownFromUrl, processChildElements, processMarkdownObject, relationships, temp, templatePath, url, walk, zip,
    __slice = [].slice,
    _this = this;
  ...
  processMarkdownObject = function(object, levelOffset) {
    var attributes, childElements, children, count, el, elements, fragments, href, itemElements, itemType, l, level, lines, objectType, out, rid, title, _i, _j, _k, _len, _len1, _len2;
    children = [];
  ...
  module.exports = {
    ...
    fragmentsFromFile: function(filepath, outputFile, callback, levelOffset) {
      if (levelOffset == null) {
        levelOffset = 0;
      }
      return markdownFromFile(filepath, function(err, data) {
    ...
    fragmentsFromMarkdown: function(inputMarkdown, outputFile, callback, levelOffset) {
      var fragments, markdownJSON;
      if (levelOffset == null) {
        levelOffset = 0;
      }
    ...
    fragmentsFromUrl: function(fileUrl, outputFile, callback, levelOffset) {
      if (levelOffset == null) {
        levelOffset = 0;
      }
      return markdownFromUrl(fileUrl, function(err, data) {
